...
(function ($) {
  ...
  var testimonial_4 = new Swiper(".hero-9", {
    ...
    pagination: {
      ...
      renderFraction: function (currentClass, totalClass) {
        return '<span className="' + currentClass + '"></span>' + ' <span><i className="fa-solid fa-minus increase-dash"></i></span> ' + '<span className="' + totalClass + '"></span>';
      }
    },
    breakpoints: {
      1200: {
  ...
  /////////////////////////////////////////////////////
  // 32. Menu Text Animation
  document.querySelectorAll('.menu-anim > li > a').forEach(button => button.innerHTML = '<div className="menu-text"><span>' + button.textContent.split('').join('</span><span>') + '</span></div>');
  ...
  //         <svg className="circle-progress"><circle className="circle-origin" r="24.5" cx="25" cy="25"></circle></svg><span></span>
  //       </button>
  //     `;
  //     }
  //   }
  ...
  for (let i = 0; i < total_row; i++) {
    border_row.innerHTML += '<span className="sec-line"></span> '
  }
